...
from lark import monotonic_align

from torch.nn import Conv1d, ConvTranspose1d, AvgPool1d, Conv2d
from torch.nn.utils import weight_norm, remove_weight_norm, spectral_norm
from lark.utils.common import init_weights, get_padding
import numpy as np
...
class SynthesizerTrnSim(nn.Module):
    """
    ...
    def forward(self, x, x_lengths, y=None, y_lengths=None, sid=None):
        if torch.onnx.is_in_onnx_export():
            return self.infer(
                x, x_lengths, noise_scale=0, noise_scale_w=0, length_scale=1
            )
        else:
